...
RELATIONS = [
    ('CLIENTES', 'CONTRATOS_CLIENTE', 'ASSINA'),
    ('CONTRATOS_CLIENTE', 'ESPECIFICACOES_SERVICO', 'INCLUI'),
    ('ESPECIFICACOES_SERVICO', 'SOLICITACOES_SERVICO', 'DETALHA'),
    ('SOLICITACOES_SERVICO', 'METRICAS_SOLICITACAO', 'MEDE'),
    ('SOLICITACOES_SERVICO', 'ALOCACOES_RECURSOS', 'USA'),
    ('ALOCACOES_RECURSOS', 'APONTAMENTOS_TEMPO', 'REGISTRA'),
    ('FORNECEDORES', 'CONTRATOS_FORNECEDOR', 'FIRMA'),
    ('FORNECEDORES', 'RECURSOS_FORNECEDOR', 'ALOCA'),
    ('PERFIS_RECURSOS', 'RECURSOS_FORNECEDOR', 'CLASSIFICA'),
    ('CONTRATOS_FORNECEDOR', 'ORDENS_SERVICO', 'ORIGINA'),
    ('PERFIS_RECURSOS', 'ORDENS_SERVICO', 'SOLICITA'),
    ('ORDENS_SERVICO', 'ALOCACOES_RECURSOS', 'ATENDE'),
    ('RECURSOS_FORNECEDOR', 'ALOCACOES_RECURSOS', 'PARTICIPA')
]
